...
export function Contacte() {
  ...
  const tableData: TableRow[] = [
    { nume: 'Andrei', telefon: '+0757 888 888', email: '', adaugat: 'Andrei Dan', data: '12.06.2025' },
    { nume: 'Papa Florea', telefon: '+0746 855 159', email: '', adaugat: 'Andrei Dan', data: '21.07.2025' },
    { nume: 'Otilia', telefon: '+40 797 103 099', email: '', adaugat: 'Maria Popescu', data: '31.07.2025' },
    { nume: 'Natalia', telefon: '+0762 743 623', email: '', adaugat: 'Andrei Dan', data: '04.05.2025' },
    { nume: 'Liliana', telefon: '+0770 244 762', email: '', adaugat: 'Andrei Dan', data: '16.07.2025' },
    { nume: 'Nicolainia', telefon: '+0747 569 729', email: '', adaugat: 'Sebastian Dragomîr', data: '11.05.2025' },
    { nume: 'Andrei', telefon: '+0490 565 60054', email: '', adaugat: 'Sebastian Dragomîr', data: '25.08.2025' },
    { nume: 'Carmen', telefon: '+0791 653 165', email: '', adaugat: 'Sebastian Dragomîr', data: '19.05.2025' },
    { nume: 'Marius', telefon: '+0791 043 054', email: '', adaugat: 'Andrei Dan', data: '28.05.2025' },
    { nume: 'Spanu Rares', telefon: '+0764 893 315', email: '', adaugat: 'Sebastian Dragomîr', data: '18.05.2025' },
    { nume: 'Ene Valentin', telefon: '+0768 695 509', email: '', adaugat: 'Andrei Dan', data: '28.05.2025' },
    { nume: 'Vladymyr', telefon: '+380 932 095 865', email: '', adaugat: 'Andrei Dan', data: '24.05.2025' },
    { nume: 'Cristian', telefon: '+0729 947 732', email: '', adaugat: 'Andrei Dan', data: '04.05.2025' },
    { nume: 'Loredana', telefon: '+0754 285 459', email: '', adaugat: 'Sebastian Dragomîr', data: '04.05.2025' },
    { nume: 'Gabi', telefon: '+0726 546 051', email: '', adaugat: 'Sebastian Dragomîr', data: '30.03.2025' },
  ];
