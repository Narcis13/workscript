...
export class DateTimeNode extends WorkflowNode {
   ...
   */
  private parseToDate(value: any, inputFormat?: string): Date {
   ...
   */
  private modifyDate(date: Date, amount: number, unit: TimeUnit): void {
    switch (unit) {
      case 'years':
