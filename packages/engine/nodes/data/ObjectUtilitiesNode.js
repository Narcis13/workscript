...
export class ObjectUtilitiesNode extends WorkflowNode {
     ...
     */
    operationMerge(target, source, overwrite) {
     ...
     */
    operationDeepMerge(target, source, overwrite) {
        if (typeof target !== 'object' || target === null) {
            return source;
        }
        if (typeof source !== 'object' || source === null) {
     ...
     */
    operationDeepClone(obj, seen = new WeakMap()) {
        // Handle primitives
        if (obj === null || typeof obj !== 'object') {
            return obj;
        }
     ...
     */
    operationSetNested(obj, path, value) {
        if (obj === null || typeof obj !== 'object') {
            return obj;
        }
     ...
     */
    operationDeleteNested(obj, path) {
        if (obj === null || typeof obj !== 'object') {
            return obj;
        }
        // Create a copy to avoid mutation
