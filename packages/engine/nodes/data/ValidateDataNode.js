...
export class ValidateDataNode extends WorkflowNode {
    ...
    async execute(context, config) {
        const { validationType = 'required_fields', schema, typeChecks, requiredFields, rangeValidations, patternValidations, customValidator, stopOnError = true, outputErrors = true } = config || {};
     ...
     */
    validateRanges(data, rangeValidations) {
        const errors = [];
     ...
     */
    validatePatterns(data, patternValidations) {
        const errors = [];
     ...
     */
    validateCustom(data, customValidator) {
        const errors = [];
        try {
