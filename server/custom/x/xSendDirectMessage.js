...
let XSendDirectMessageNode = class XSendDirectMessageNode {
    metadata = {
    ...
    async getOrCreateConversation(recipientId, bearerToken) {
...
XSendDirectMessageNode = __decorate([
    RegisterNode
], XSendDirectMessageNode);
export { XSendDirectMessageNode };
