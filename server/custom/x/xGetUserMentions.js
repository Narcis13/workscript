...
let XGetUserMentionsNode = class XGetUserMentionsNode {
    metadata = {
...
XGetUserMentionsNode = __decorate([
    RegisterNode
], XGetUserMentionsNode);
export { XGetUserMentionsNode };
