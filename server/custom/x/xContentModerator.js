...
let XContentModeratorNode = class XContentModeratorNode {
    metadata = {
    ...
    checkSpam(content, lowerContent) {
        let score = 0;
        const details = [];
    ...
    checkToxicity(content, lowerContent) {
    ...
    checkAdultContent(content, lowerContent) {
    ...
    checkViolence(content, lowerContent) {
    ...
    checkHateSpeech(content, lowerContent) {
    ...
    checkMisinformation(content, lowerContent) {
...
XContentModeratorNode = __decorate([
    RegisterNode
], XContentModeratorNode);
export { XContentModeratorNode };
