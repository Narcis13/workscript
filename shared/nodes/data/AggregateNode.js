...
export class AggregateNode extends WorkflowNode {
    ...
    async execute(context, config) {
        try {
            const { mode = 'all_data', fields = [], outputField = 'data', includeBinaries = false, keepMissingValues = false } = config || {};
            // Validate mode
     ...
     * @private
     */
    aggregateIndividualFields(items, fields, keepMissingValues, includeBinaries) {
        const result = {};
     ...
     * @private
     */
    aggregateAllData(items, outputField, includeBinaries) {
        const result = {};
