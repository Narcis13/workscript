...
import composabilityRoutes from './routes/composability';
...
reflectionRouter.route('/composability', composabilityRoutes);
reflectionRouter.route('/patterns', patternsRoutes);
